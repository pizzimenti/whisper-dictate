"""Session D-Bus terminal control helper for kdictate."""
...
from kdictate.runtime import STATE_ERROR, STATE_IDLE, STATE_RECORDING, STATE_STARTING, STATE_TRANSCRIBING

_logger = logging.getLogger("kdictate.cli")
...
def build_parser() -> argparse.ArgumentParser:
    ...
    parser = argparse.ArgumentParser(description="Terminal control for kdictate.")
...
def main(argv: Sequence[str] | None = None) -> int:
    ...
    logger = configure_logging("kdictate.cli")
